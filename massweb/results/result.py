...
class Result(object):
    ...
    def __unicode__(self):
        ...
        if self.fuzzy_target.ttype == "get":
            to_ret = json.dumps({"url" : unicode(self.fuzzy_target), "data" : self.fuzzy_target.data, "results" : self.result_dic, "request_type" : "get", "fuzzy_param" : self.fuzzy_target.fuzzy_param})
