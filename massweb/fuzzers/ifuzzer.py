...
class iFuzzer(object):
    ...
    def replace_param_value(self, url, param, replacement_string):
        ...
        #FIXME: Clarify with alex: !potential bug here? This expects a list,
        #  but seems to work
        ...
        #  (thanks urlencode!)
        #FIXME: Clarify with alex: !might cause some incorrect query params and
        #  keys with utf-8, needs more testing
        str_query_dic = {}
    ...
    def append_to_param(self, url, param, append_string):
        ...
        #FIXME: !might cause some incorrect query params and keys with utf-8,
        #  needs more testing
        str_query_dic = {}
        for k, v in query_dic.iteritems():
            str_query_dic[unicode(k).encode('utf-8', 'replace')] = [x.encode('utf-8', 'replace') for x in v]
